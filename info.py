...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003303429005 -1003506154715').split()]  # For Multiple Id Use One Space Between Each.
